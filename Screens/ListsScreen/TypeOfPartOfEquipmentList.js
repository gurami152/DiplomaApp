...
class TypeOfPartOfEquipementList extends React.Component {
    ...
    loadData = () => {
        ...
        fetch("http://192.168.1.101:8081/api/typeOfPartOfEquipment/all", {
            method: "GET",
            headers: {
...
export default TypeOfPartOfEquipementList
